...
class PaymentService {
    constructor() {
        ...
        this.redirectUrl = process.env.REDIRECT_URL || 'http://localhost:7400/payment-response';
    }
    ...
    async initiatePayment(paymentDetails) {
        try {
            ...
            const data = {
                ...
                callbackUrl: paymentDetails?.callbackUrl || 'http://localhost:7400/api/v1/check-payment',
