...
class PaymentService {
    constructor() {
        ...
        this.redirectUrl = process.env.REDIRECT_URL || 'https://www.api.dyfru.com/payment-response';
    }
    ...
    async initiatePayment(paymentDetails) {
        try {
            ...
            const data = {
                ...
                callbackUrl: paymentDetails?.callbackUrl || 'https://www.api.dyfru.com/api/v1/check-payment',
