    ...
    useEffect(() => {
        const calculateTotal = () => {
            ...
            const subtotal = cart.reduce((total, item) =>
                total + (item.price_after_discount * item.Qunatity), 0
            );
        ...
        calculateTotal();
    }, [cart, settings]); // Recommended to track dependencies
            ...
            <div className="min-h-screen bg-gray-50">
                <div className="container mx-auto px-4 py-8">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 relative">
                        ...
                        <div className={`${cart.length === 0 ? 'lg:w-full':'lg:w-2/3'} w-full space-y-8 overflow-y-auto`} >
                            {/* Cart Items */}
                            {cart.length > 0 ? (
                                ...
                                <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
                                    ...
                                    <button onClick={()=>window.location.href="/Shop"} className="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors">
                                        Start Shopping
                                    </button>
                                </div>
                            )}
                                ...
                                <div className="space-y-4">
                                    ...
                                    {settings?.shippingEnabled && (
                                        subTotal < settings?.freeShippingThreshold ? (
                                            <div className="flex justify-between text-gray-600">
                                                <span>Shipping</span>
                                                <span>₹{settings.shippingCost || 40}</span>
                                            </div>
                                        ) : (
                                    ...
                                    <div className="border-t pt-4 mt-4">
                                        <div className="flex justify-between font-bold text-lg">
                                            <span>Total</span>
                                            <span className="text-green-600">₹{total || 0}</span>
                                        </div>
                                    </div>
                                </div>
                                {user ? (
